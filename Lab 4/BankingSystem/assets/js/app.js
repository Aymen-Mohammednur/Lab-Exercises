        ...
        if (isNaN(choice)) {
            ...
            if (choice == "1") {
                ...
                if (isNaN(Number(amount))) {
                    ...
                    console.log(chosenAcc.deposit(Number(amount)));
                    main();
                }   
            }
            else if (choice == "2") {
                ...
                if (isNaN(Number(amount))) {
                    ...
                    console.log(chosenAcc.withdraw(Number(amount)));
                    main();
                }
                ...
                let amount = prompt("Amount to Transfer ");
                if (isNaN(Number(amount))) {
                    console.log("Input numbers only!");
                    main();
                }
                    ...
                    if ((accounts.indexOf(chosenAcc)) + 1 == receiver) {
                        ...
                        console.log(chosenAcc.transfer(Number(amount), accounts[receiver - 1]));
                        main();
                    }
                }        
            }
